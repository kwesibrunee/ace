...
return (function(undefined) {
  ...
  var modules = {
    define: function(name, factory) {
      ...
      factory(module, requirepeg);
      this[name] = module.exports;
    }
  };

  modules.define("utils/arrays", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("utils/objects", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("utils/classes", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("grammar-error", function(module, requirepeg) {
    "use strict";

    var classes = requirepeg("./utils/classes");
  ...
  modules.define("parser", function(module, requirepeg) {
  ...
  modules.define("compiler/visitor", function(module, requirepeg) {
    "use strict";

    var objects = requirepeg("../utils/objects"),
        arrays  = requirepeg("../utils/arrays");
  ...
  modules.define("compiler/asts", function(module, requirepeg) {
    "use strict";

    var arrays  = requirepeg("../utils/arrays"),
        visitor = requirepeg("./visitor");
  ...
  modules.define("compiler/opcodes", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("compiler/javascript", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("compiler/passes/generate-bytecode", function(module, requirepeg) {
    "use strict";

    var arrays  = requirepeg("../../utils/arrays"),
        objects = requirepeg("../../utils/objects"),
        asts    = requirepeg("../asts"),
        visitor = requirepeg("../visitor"),
        op      = requirepeg("../opcodes"),
        js      = requirepeg("../javascript");
  ...
  modules.define("compiler/passes/generate-javascript", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("compiler/passes/remove-proxy-rules", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("compiler/passes/report-left-recursion", function(module, requirepeg) {
    "use strict";

    var arrays       = requirepeg("../../utils/arrays"),
        GrammarError = requirepeg("../../grammar-error"),
        asts         = requirepeg("../asts"),
        visitor      = requirepeg("../visitor");
  ...
  modules.define("compiler/passes/report-infinite-loops", function(module, requirepeg) {
    "use strict";

    var GrammarError = requirepeg("../../grammar-error"),
        asts         = requirepeg("../asts"),
        visitor      = requirepeg("../visitor");
  ...
  modules.define("compiler/passes/report-missing-rules", function(module, requirepeg) {
    "use strict";
  ...
  modules.define("compiler", function(module, requirepeg) {
    "use strict";
    ...
    var compiler = {
      ...
      passes: {
        check: {
          reportMissingRules:  requirepeg("./compiler/passes/report-missing-rules"),
          reportLeftRecursion: requirepeg("./compiler/passes/report-left-recursion"),
          reportInfiniteLoops: requirepeg("./compiler/passes/report-infinite-loops")
        },
        transform: {
          removeProxyRules:    requirepeg("./compiler/passes/remove-proxy-rules")
        },
        generate: {
          generateBytecode:    requirepeg("./compiler/passes/generate-bytecode"),
          generateJavascript:  requirepeg("./compiler/passes/generate-javascript")
        }
      },
  ...
  modules.define("peg", function(module, requirepeg) {
    "use strict";
    ...
    var PEG = {
      ...
      GrammarError: requirepeg("./grammar-error"),
      parser:       requirepeg("./parser"),
      compiler:     requirepeg("./compiler"),
